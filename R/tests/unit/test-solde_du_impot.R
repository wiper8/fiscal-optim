...
expect_equal(
  solde_du_impot(
    ...
    interests = 0, rente_emploi = 0, cotis_rente = 0, pension_psv = 0, prestation_rrq = 0, cotis_ae = 0, cotis_rqap = 0
  )$l48500,
  3453,
  tolerance = 3453 * 0.1,
  scale = 1
...
expect_equal(
  solde_du_impot(
    ...
    interests = 5000, rente_emploi = 0, cotis_rente = 0, pension_psv = 0, prestation_rrq = 0, cotis_ae = 0,
    cotis_rqap = 0
  )$l48500,
  3652,
  tolerance = 3652 * 0.1,
...
expect_equal(
  solde_du_impot(
    ...
    interests = 0, rente_emploi = 10000, cotis_rente = 0, pension_psv = 10000, prestation_rrq = 10000, cotis_ae = 0,
    cotis_rqap = 0
  )$l48500,
  3751,
  tolerance = 3751 * 0.1,
...
expect_equal(
  solde_du_impot(
    ...
    interests = 0, rente_emploi = 0, cotis_rente = 20000, pension_psv = 0, prestation_rrq = 0, cotis_ae = 0,
    cotis_rqap = 0
  )$l48500,
  1032,
  tolerance = 1032 * 0.11,
