...
expect_equal(
  annexe_7(
    cotisations_inutilisees_versees_dispo_a_deduire = c(3, Inf, 100, 100),
    cotisations_versees_reer = c(2, 2, 2, -6),
    deduction_reer = c(1, 5, 5, 5),
    max_deductible_reer = c(Inf, 8, 8, 8)
  ),
  list(
    l20800 = c(1, 5, 5, 5),
    l24500 = c(2, 2, 2, 0),
    cotis_inutil_vers_disp_deduc = c(4, Inf, 97, 95)
  )
)
